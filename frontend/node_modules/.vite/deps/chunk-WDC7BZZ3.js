import {
  ConnectorUtil,
  WalletUtil
} from "./chunk-LDZ7XSDM.js";
import {
  W3mFrameHelpers,
  W3mFrameProvider
} from "./chunk-K3QGF3RL.js";
import {
  CaipNetworksUtil,
...
var AppKit = class extends AppKitBaseClient {
  ...
  async loadModalComponents(features, remoteFeatures) {
    ...
    if (usingEmbeddedWallet) {
      featureImportPromises.push(import("./embedded-wallet-EFZ7VSPC.js"));
    }
    if (remoteFeatures.email) {
      featureImportPromises.push(import("./email-TT565QWZ.js"));
    }
    if (remoteFeatures.socials) {
      featureImportPromises.push(import("./socials-JLOXDVDJ.js"));
    }
    if (remoteFeatures.swaps && remoteFeatures.swaps.length > 0) {
      featureImportPromises.push(import("./swaps-OCBLXKDS.js"));
    }
    if (features.send) {
      featureImportPromises.push(import("./send-XQ64DYMG.js"));
    }
    if (features.receive) {
      featureImportPromises.push(import("./receive-5RVJ3FN5.js"));
    }
    if (remoteFeatures.onramp && remoteFeatures.onramp.length > 0) {
      featureImportPromises.push(import("./onramp-H5QNX6JU.js"));
    }
    if (remoteFeatures.activity) {
      featureImportPromises.push(import("./transactions-CUZXMD64.js"));
    }
    if (features.pay) {
      featureImportPromises.push(import("./exports-Z5YS2ODP.js"));
    }
    if (remoteFeatures.emailCapture) {
      featureImportPromises.push(import("./ui-NV7YXKUB.js"));
    }
    await Promise.all([
      ...featureImportPromises,
      import("./exports-AAQZJ2QB.js"),
      import("./w3m-modal-ZRICUH54.js")
    ]);
  }
};
...
//# sourceMappingURL=chunk-WDC7BZZ3.js.map
