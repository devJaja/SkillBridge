import {
  ConnectorUtil,
  WalletUtil
} from "./chunk-EXVNLRGI.js";
import {
  W3mFrameHelpers,
  W3mFrameProvider
} from "./chunk-KCZCKVDV.js";
import {
  CaipNetworksUtil,
...
var AppKit = class extends AppKitBaseClient {
  ...
  async loadModalComponents(features, remoteFeatures) {
    ...
    if (usingEmbeddedWallet) {
      featureImportPromises.push(import("./embedded-wallet-QDQZZX73.js"));
    }
    if (remoteFeatures.email) {
      featureImportPromises.push(import("./email-I2535BY4.js"));
    }
    if (remoteFeatures.socials) {
      featureImportPromises.push(import("./socials-SPUN77IW.js"));
    }
    if (remoteFeatures.swaps && remoteFeatures.swaps.length > 0) {
      featureImportPromises.push(import("./swaps-UVHH2RKV.js"));
    }
    if (features.send) {
      featureImportPromises.push(import("./send-KA3ZAZKL.js"));
    }
    if (features.receive) {
      featureImportPromises.push(import("./receive-WMFE5BAZ.js"));
    }
    if (remoteFeatures.onramp && remoteFeatures.onramp.length > 0) {
      featureImportPromises.push(import("./onramp-THCJMNZM.js"));
    }
    if (remoteFeatures.activity) {
      featureImportPromises.push(import("./transactions-XGUOPIJS.js"));
    }
    if (features.pay) {
      featureImportPromises.push(import("./exports-D6HPAWRQ.js"));
    }
    if (remoteFeatures.emailCapture) {
      featureImportPromises.push(import("./ui-5W6U3VT4.js"));
    }
    await Promise.all([
      ...featureImportPromises,
      import("./exports-FVMRKAKV.js"),
      import("./w3m-modal-G5SQAWNR.js")
    ]);
  }
};

// node_modules/@reown/appkit/dist/esm/exports/constants.js
var PACKAGE_VERSION = "1.7.19";
...
//# sourceMappingURL=chunk-LDXERNUH.js.map
