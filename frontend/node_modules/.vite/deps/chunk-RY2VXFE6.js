    ...
    return html`
      <button ?disabled=${this.disabled}>
        ...
        <wui-flex flexDirection="column" justifyContent="spaceBetween">
          ${this.titleTemplate()}
          ${this.description ? html`<wui-text variant="small-400" color="fg-200"> ${this.description}</wui-text>` : null}</wui-flex
        >
      </button>
    `;
  }
...
//# sourceMappingURL=chunk-RY2VXFE6.js.map
